...
echo "		THICKNESS"
perl ../compareMatrix.pl  /home/knotman/git/SCIARA_FV2_CUDA/SCIARA_FV2_CUDA_ADAPTIVE_GRID/data/2001_tagliata/output/THICKNESS.out.sst \
						"./output/ORIGINAL_000000"$STEPS"_Thickness.stt" $2

echo "		TEMPERATURE"
perl ../compareMatrix.pl /home/knotman/git/SCIARA_FV2_CUDA/SCIARA_FV2_CUDA_ADAPTIVE_GRID/data/2001_tagliata/output/TEMPERATURE.out.sst \
						"./output/ORIGINAL_000000"$STEPS"_Temperature.stt" $3

echo "		QUOTE"
perl ../compareMatrix.pl /home/knotman/git/SCIARA_FV2_CUDA/SCIARA_FV2_CUDA_ADAPTIVE_GRID/data/2001_tagliata/output/QUOTE.out.sst \
						"./output/ORIGINAL_000000"$STEPS"_Morphology.stt" $4
echo "		SOLIDIFIED"
perl ../compareMatrix.pl /home/knotman/git/SCIARA_FV2_CUDA/SCIARA_FV2_CUDA_ADAPTIVE_GRID/data/2001_tagliata/output/SOLIFIED_LAVA.out.sst \
