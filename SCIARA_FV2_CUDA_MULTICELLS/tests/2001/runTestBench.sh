...
SERIAL_CONF=$SERIAL_HOME/data201/2001_tagliata/2001_000000000000.cfg

CUDA_EXE=$CUDA_HOME/Debug/SCIARA_FV2_CUDA_ADAPTIVE_GRID
CUDA_CONF=$CUDA_HOME/data/2001_tagliata/PARAMETERS.cfg
...
for i in 001000 001500 002000 002500 003000 003500 004000 004500 005000 005500 006000 006500 007000 007500 008000 008500 009000 009500 010000
do
#run the serial version
	...
	$CUDA_EXE -c $CUDA_HOME/data/2001_tagliata/  #>> $RESULT_FILE_CUDA

	./compareMatrices_steps_2001.sh $i Y Y Y Y > output/comparison/result_comparision_"$i".txt
